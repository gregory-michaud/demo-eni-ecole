...
import fr.eni.demo.dal.EtudiantRepository;
...
@Slf4j
@DataJpaTest
public class TestOneToManyBidirectionnel {
    ...
    public void test_save(){
        ...
        for (int i = 0; i < 3; i++) {
            ...
            EtudiantEni etudiantEni = optionalEtudiantEni.get();
            log.info(etudiantEni.toString());
            assertThat(etudiantEni.getPromo().getNom()).isEqualTo("PromoTest");
        }
    }
